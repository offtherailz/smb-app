        ...
        if (!skipMessage) {
            ...
            for (Intent intent : POWERMANAGER_INTENTS) {
                if (isCallable(context, intent)) {
                    ...
                    Spanned message = Html.fromHtml(String.format("%s requires to be enabled in 'Protected Apps' to function properly.%n", context.getString(R.string.app_name)));
                    switch (intent.getComponent().getClassName()) {
                        case "com.huawei.systemmanager.power.ui.HwPowerManagerActivity":
                            message = Html.fromHtml(context.getString(R.string.huauei_emui_powersaving_instructions));
                            break;
                    }
